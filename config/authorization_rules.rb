authorization do
  ...
  role :anonymous do
    has_permission_on [ :nodes, :projects, :documents, :document_versions, :sketchspaces ] do
      to :index, :show, :download, :show_children_deferred
  ...
  role :user do
    ...
    has_permission_on [ :nodes, :projects, :documents, :document_versions, :sketchspaces ] do
      to :delete, :edit, :index, :show, :update, :destroy, :download, :upload, :subscribe, :unsubscribe, :move, :submitmove, :delete_tag, :show_children_deferred
